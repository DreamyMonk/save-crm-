  ...
  products: [
    {
      ...
      category: "Solar",
      productClass: "Solar",
      productName: "6.6 kW rooftop solar package",
      brandName: "SavePlanet",
      model: "SP-6.6KW",
      productType: "Solar package",
      productConfiguration: "Grid connected",
      productUnitMount: "Roof mount",
      status: "Approved",
      imageUrl: "",
      description: "Grid-connected rooftop solar package with panels, inverter, mounting, and installation support.",
      price: 7200,
    },
    {
      id: "P-1002",
      category: "Aircon",
      productClass: "6B(i)",
      productName: "High efficiency split aircon",
      brandName: "EcoCool",
      model: "EC-18S",
      productType: "Ducted",
      ...
      coolingCapacity: "13.0200",
      aeER: "3.3230",
      acop: "3.4900",
      refrigerant: "R-32",
      status: "Approved",
      imageUrl: "",
      description: "Commercial-grade split air conditioning system with energy efficient operation.",
      price: 1850,
    },
    {
      id: "P-1003",
      category: "Inverter",
      productClass: "Inverter",
      productName: "Hybrid solar inverter",
      brandName: "VoltMax",
      model: "VM-HYB-5K",
      productType: "Hybrid inverter",
      productConfiguration: "Battery ready",
      status: "Approved",
      imageUrl: "",
      description: "Hybrid inverter for solar and battery-ready installations.",
      price: 2400,
    },
    {
      id: "P-1101",
      category: "Aircon",
      productClass: "6F",
      productName: "Midea MDV-V244WN1 outdoor unit",
      brandName: "MIDEA",
      ...
      gemsClass: "Class 20",
      heatingCapacity: "24.40",
      coolingCapacity: "20.00",
      aeER: "3.767",
      acop: "4.106",
      refrigerant: "R-410A",
      status: "Approved",
      imageUrl: "",
      description: "Outdoor unit for multi-head Midea upgrade configuration.",
      price: 0,
    },
    ...[
      ["P-1102", "MFAG26VA-N", "2.6kW Venus indoor head", "2.60", "2.50", 245],
      ["P-1103", "MFAG36VA-N", "3.6kW Venus indoor head", "3.80", "3.55", 285],
      ["P-1104", "MFAG50VA-N", "5.0kW Venus indoor head", "5.00", "5.10", 355],
      ["P-1105", "MFAG60VA-N", "6.0kW Venus indoor head", "6.00", "6.20", 445],
      ["P-1106", "MFAG80VA-N", "8.0kW Venus indoor head", "8.50", "8.00", 522.8],
      ["P-1107", "MFAG26VA-W", "2.6kW Venus indoor head", "2.60", "2.50", 245],
      ["P-1108", "MFAG36VA-W", "3.6kW Venus indoor head", "3.80", "3.55", 285],
      ["P-1109", "MFAG50VA-W", "5.0kW Venus indoor head", "5.00", "5.10", 355],
      ["P-1110", "MFAG60VA-W", "6.0kW Venus indoor head", "6.00", "6.20", 445],
      ["P-1111", "MFAG80VA-W", "8.0kW Venus indoor head", "8.50", "8.00", 522.8],
      ["P-1112", "DUCMI70I/UCMI70O", "7.0kW ducted system", "7.10", "7.00", 1850],
      ["P-1113", "DUCMI90I/UCMI90O", "9.0kW ducted system", "9.00", "9.00", 2150],
      ["P-1114", "DUCMI105IH/UCMI105OH", "10.5kW ducted system", "10.50", "10.50", 2550],
      ["P-1115", "DUCMI140IH/UCMI140OH", "14.0kW ducted system", "14.00", "14.00", 3100],
      ["P-1116", "DUCMI170IHB/UCMI170OB", "17.0kW ducted system", "17.00", "17.00", 3650],
    ].map(([id, model, name, heating, cooling, price]) => ({
      id: String(id),
      category: "Aircon" as ProductCategory,
      productClass: String(model).startsWith("DUC") ? "6B(i)" : "6D",
      productName: String(name),
      brandName: "MIDEA",
      model: String(model),
      productType: String(model).startsWith("DUC") ? "Ducted" : "Non-Ducted",
      productConfiguration: String(model).startsWith("DUC") ? "Ducted system" : "Single split system",
      productUnitMount: String(model).startsWith("DUC") ? "Ceiling concealed" : "Wall Hung",
      gemsClass: String(model).startsWith("DUC") ? "Class 11" : "Class 8",
      heatingCapacity: String(heating),
      coolingCapacity: String(cooling),
      aeER: "4.419",
      acop: "4.560",
      gemsHspfMixed: "8.842",
      gemsTcspfCold: "7.641",
      gemsTcspfMixed: "7.023",
      refrigerant: "R-32",
      status: "Approved",
      imageUrl: "",
      description: "Midea air conditioner model for quote and rebate calculations.",
      price: Number(price),
    })),
  ],
  quotes: [],
